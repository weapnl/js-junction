...
const request = await new User()
    ...
    .pagination(1, 25, 50, true) // The 4th parameter is a simple pagination parameter. You can use this to simply navigate through pages (without receiving the total pages). This can be helpful for large database tables.
    .get();
```
